...
A PHP implementation of the Point QuadTree data structure, returning search results as an SPLHeap so that they are sorted according to the heap's defined compare() method rule

The /examples folder contains a couple of examples to demonstrate its use:

 - citySearch.php

    allows a search on a defined bounding box, and will display a list of cities that fall within that bounding box, sorted by their distance from the centre point of the bounding box
...
Data for the list of cities is from [geonames.org](http://www.geonames.org/ "Geonames"), licensed under a [Creative Commons Attribution 3.0 License](http://creativecommons.org/licenses/by/3.0/ "Creative Commons Attribution License 3.0"), and provided "as is" without warranty or any representation of accuracy, timeliness or completeness.
 ...
 - lunarLandingSearch.php
    ...
    allows a search on a defined bounding box, and will display a list of moon landings that fall within that bounding box, sorted by the date of their landing
